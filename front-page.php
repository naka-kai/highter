...
<section class="feature">
  <div class="container feature_container">
    ...
    <div class="feature_box row-reverse">
      <div class="feature_box-img"><img src="<?php echo get_stylesheet_uri(); ?>/../img/feature01.jpg" alt=""></div>
    ...
    <div class="feature_box">
      <div class="feature_box-img"><img src="<?php echo get_stylesheet_uri(); ?>/../img/feature02.jpg" alt=""></div>
    ...
    <!-- /.feature_box -->
    <div class="feature_box row-reverse">
      <div class="feature_box-img"><img src="<?php echo get_stylesheet_uri(); ?>/../img/feature03.jpg" alt=""></div>
      <div class="feature_box-text-box">
