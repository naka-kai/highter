...
<head>
  ...
  <link rel="stylesheet" href="css/blog_detail_css/blog_detail_main.css">
  <link rel="stylesheet" href="css/share_css/contact.css">
  <link rel="stylesheet" href="css/blog_detail_css/blog_detail_contact.css">
    ...
    <div class="breadcrumb-list-box">
      <div class="container">
        <ul class="breadcrumb-list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          <li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <a class="item" href="https://kaiblo.com/portfolio/heighter/"><small>ブログ</small></a>
            <meta itemprop="position" content="2" />
          </li>
          <li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <a class="item" href="https://kaiblo.com/portfolio/heighter/"><small>カテゴリ1</small></a>
            <meta itemprop="position" content="2" />
          </li>
          <li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <small>ブログタイトルテキストテキストテキストテキスト</small>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="container">
        <div class="footer_top">
          ...
          <div class="footer_top-right">
            <div class="footer_logo"><a href=""><img src="<?php echo get_template_directory_uri(); ?>/img/logo.jpg" alt="Engress"></a></div>
            <div class="footer_top-right-tel-box">
              <p class="footer_top-right_tel-contact-number p"><a href="tel:0123-456-7890">0123-456-7890</a></p><small class="footer_top-right_tel-contact-hour">平日08:00~20:00</small>
            </div>
          </div>
        </div>
      </div>
