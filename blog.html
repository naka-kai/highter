...
<head>
  ...
  <link rel="stylesheet" href="css/blog_css/blog_mainvisual.css">
  <link rel="stylesheet" href="css/share_css/breadcrumb.css">
  <link rel="stylesheet" href="css/home_css/blog.css">
  <link rel="stylesheet" href="css/blog_css/blog_main.css">
    ...
    <div class="container blog_container">
      <div class="articles">
        ...
        <article class="blog_article">
          <figure class="blog_article-img-box"><img src="<?php echo get_template_directory_uri(); ?>/img/sample01.svg"
              alt=""><small class="blog_category">カテゴリー</small>
          </figure>
        ...
        <article class="blog_article">
          <figure class="blog_article-img-box"><img src="<?php echo get_template_directory_uri(); ?>/img/sample02.svg"
              alt=""><small class="blog_category">カテゴリー</small>
          </figure>
          <div class="blog_article-text-box">
            <p class="blog_article-date">2020-12-01</p>
        ...
        <article class="blog_article">
          <figure class="blog_article-img-box"><img src="<?php echo get_template_directory_uri(); ?>/img/sample03.svg"
              alt=""><small class="blog_category">カテゴリー</small>
          </figure>
          <div class="blog_article-text-box">
            <p class="blog_article-date">2020-12-01</p>
