...
function add_css_js() {
  ...
  //page-price.phpにprice/price.cssを読み込み
  if(is_page('price')) {
  ...
  if(is_single('news')) {
    wp_enqueue_style('news-maincss', get_template_directory_uri().'/css/news_detail_css/news_detail_main.css');
    wp_enqueue_style('news-mainvisualcss', get_template_directory_uri().'/css/news_detail_css/news_detail_main.css');
  }
  ...
  if(is_page('price')) {
    wp_enqueue_script('scrollHintjs', get_template_directory_uri().'/js/scrollHint.js');
  }
}
