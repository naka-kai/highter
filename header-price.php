...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/price_css/price_mainvisual.css">
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/share_css/mainvisual.css">
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/share_css/breadcrumb.css">
  <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/price_css/price_main.css">
  ...
  wp_enqueue_script('scrollHint-script', get_stylesheet_directory_uri() . '/js/scrollHint.js');
  ?>
