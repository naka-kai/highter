    ...
    <div class="container blog-news-container">
      <section class="blog">
        ...
        <div class="blog_articles">
          ...
          <article class="blog_article">
            <figure class="blog_article-img-box"><img src="img/sample02.svg" alt=""><small class="blog_category">カテゴリー</small></figure>
            <div class="blog_article-text-box">
              <p class="blog_article-title">Engressもくもく会でみんなでTOEFL学習をしませんか？</p><small class="blog_article-date">2020-12-01</small>
            </div>
          </article>
          <article class="blog_article">
            <figure class="blog_article-img-box"><img src="img/sample03.svg" alt=""><small class="blog_category">カテゴリー</small></figure>
            <div class="blog_article-text-box">
